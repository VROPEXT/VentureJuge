  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="bg-gradient-to-br from-amber-900/20 to-amber-800/5 border border-amber-700/30 rounded-2xl p-6 text-center">
        ...
        <h3 className="font-serif font-bold text-foreground text-lg mb-2">Générer le Business Plan</h3>
        <p className="text-sm text-muted-foreground max-w-sm mx-auto mb-5 leading-relaxed">
          Business plan complet avec projections financières, plan marketing et feuille de route. Téléchargeable en PDF.
        </p>
        <button
