...
export function HomePage() {
  ...
  // Auto-activate Premium for VIP accounts
  useEffect(() => {
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <button
                ...
                className="flex items-center gap-2 bg-secondary border border-border rounded-full px-3 py-1.5 hover:border-gold-500/40 hover:text-foreground transition-all"
              >
      ...
      {showAccountModal && (
        <AccountModal
          ...
          onCancelSubscription={() => {
            setIsPremium(false);
            setFreeRequestsLeft(Math.max(0, 1 - getFreemiumState().requestsThisMonth));
          }}
        />
      )}
    </div>
